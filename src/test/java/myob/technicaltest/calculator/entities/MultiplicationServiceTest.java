...
public class MultiplicationServiceTest {
	...
	@Test
	public void testMultiplication_CalculateResult2() throws MissingParametersException, OperationException, InvalidInputException {
		HashMap<String, List<String>> input = new HashMap<>();
		input.put("operand", new LinkedList<>());
		input.get("operand").add("10");
		input.get("operand").add("20");
	...
	@Test
	public void testMultiplication_CalculateResult3() throws MissingParametersException, OperationException, InvalidInputException {
